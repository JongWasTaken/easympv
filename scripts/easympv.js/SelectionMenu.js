...
var SelectionMenu = function (settings) {
  ...
  this.cbMenuRight =
    typeof settings.cbMenuRight === "function" ? settings.cbMenuRight : null;
  this.cbMenuOpen =
  ...
  this.menuFontAlpha = Ass.convertPercentToHex(
  ...
  this.autoCloseDelay =
    typeof settings.autoCloseDelay === "number" && settings.autoCloseDelay >= 0
...
SelectionMenu.prototype._processBindings = function (fnCb) {
  if (typeof fnCb !== "function") throw "Missing callback for _processBindings";
  ...
  switch (action) {
    ...
    case "Menu-Help":
      ...
      for (entry in bindings) {
        ...
        if (!entry.match(/^Menu-/) || !allKeys || !allKeys.length) continue;
        ...
        helpString +=
          Ass.darkred(c) +
          Ass.esc(entryTitle, c) +
          ": " +
          Ass.white(c) +
          Ass.esc("{" + allKeys.join("}, {") + "}", c) +
          "\n";
      }
...
SelectionMenu.prototype.renderMenu = function (
  ...
  finalString =
    Ass.startSeq(c) +
    Ass.alpha(this.menuFontAlpha, c) +
    Ass.gray(c) +
    Ass.scale(80, c) +
    Ass.esc(this.title, c) +
    Ass.scale(100, c) +
    Ass.white(c) +
    "\n\n" +
    Ass.alpha(this.menuFontAlpha, c) +
