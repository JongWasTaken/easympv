...
SSAHelper.setTransparencyPercentage = function (transparencyPercentage) {
	var transparencyHex = Math.floor((transparencyPercentage / 100) * 255).toString(16); 
	return "{\\alpha&H" + transparencyHex + "&}";
};
...
SSAHelper.Images.info = function () {
	...
	symbol += "m 24 14 b 25.4 14 26.5 15.1 26.5 16.5 b 26.5 17.9 25.4 19 24 19 b 22.6 19 21.5 17.9 21.5 16.5 b 21.5 15.1 22.6 14 24 14 ";
...
SSAHelper.Images.warning = function () {
	...
	symbol += "b 2.1 102.7 4.2 103.9 6.5 103.9 l 111.7 103.9 b 114 103.9 116.1 102.7 117.2 100.8 b 118.3 98.8 118.3 96.4 117.2 94.5 ";
	symbol += "l 64.5 3.3 b 63.2 1.1 60.7 -0.1 58.1 0.3 ";
	symbol += "m 58.6 2.9 b 57.6 3 56.7 3.6 56.2 4.5 l 3.2 96.3 b 2.7 97.3 2.7 98.6 3.2 99.6 b 3.8 100.6 4.9 101.3 6.1 101.3 l 112.1 101.3 b ";
	symbol += "113.3 101.3 114.4 100.6 115 99.6 b 115.6 98.6 115.6 97.3 115 96.3 l 62 4.5 b 61.3 3.3 60 2.7 58.6 2.9 m 59.1 13.4 l 104.1 92.7 l 14 92.7 l 59.1 13.4 ";
	symbol += "m 62.6 83 b 62.6 85.6 60.5 87.7 57.9 87.7 b 55.3 87.7 53.2 85.6 53.2 83 b 53.2 80.4 55.3 78.3 57.9 78.3 b 60.5 78.3 62.6 80.4 62.6 83 ";
	symbol += "m 56.1 39.1 l 59.8 39.1 b 61.7 39.1 63.2 41.4 63.2 44.3 l 61.6 67.9 b 61.6 70.8 60.1 73.1 58.2 73.1 l 57.7 73.1 ";
	symbol += "b 55.8 73.1 54.3 70.8 54.3 67.9 l 52.7 44.3 b 52.7 41.4 54.2 39.1 56.1 39.1 {\\p0}";
	return symbol + SSAHelper.reset();
}
...
SSAHelper.Images.error = function () {
	...
	symbol += "b 254 58.5 197.5 2 128 2 m 82.9 68.9 b 86.5 68.9 90.1 70.3 92.8 73 l 128 108.2 l 163.2 73 b 165.9 70.3 169.5 68.9 173.1 68.9 b 176.7 68.9 180.3 70.3 183 73 ";
	symbol += "b 188.5 78.5 188.5 87.3 183 92.8 l 147.8 128 l 183 163.2 b 188.5 168.7 188.5 177.5 183 183 ";
	symbol += "b 180.3 185.7 176.7 187.1 173.1 187.1 b 169.5 187.1 165.9 185.7 163.2 183 l 128 147.8 l 92.8 183 ";
	symbol += "b 90.1 185.7 86.5 187.1 82.9 187.1 b 79.3 187.1 75.7 185.7 73 183 b 67.5 177.5 67.5 168.7 73 163.2 ";
